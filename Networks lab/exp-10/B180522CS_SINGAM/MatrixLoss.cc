...
void experiment (bool enableCtsRts, std::string wifiManager)
{
  ...
  printf("\nLoss Model: MatrixPropagationLossModel\n\n");
  ...
  AnimationInterface anim ("ex10.xml");
...
int main (int argc, char **argv)
{
  ...
  std::cout << "Hidden station experiment with RTS/CTS enabled: Day time\n" << std::flush;
  experiment (true, wifiManager);
  std::cout << "------------------------------------------------\n";
  std::cout << "Hidden station experiment with RTS/CTS disabled: Night time\n";
